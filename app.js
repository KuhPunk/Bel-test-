...
document.addEventListener("DOMContentLoaded", () => {
      ...
      rules: [
        {
          ...
          body: "У ненаціскным першым складзе перад націскам е/я перадаюцца гукам [а] і пішуцца літарамі а/я: зямля, пяро — [п'аро]."
        },
        {
          id: "ph-2",
          title: "Акання пасля цвёрдых зычных",
          body: "Галосная о ў ненаціскной пазіцыі пасля цвёрдых зычных пераходзіць у гук [а] і пішацца літарай а: карагод, парог."
        },
        {
          id: "ph-3",
          title: "Нескладовае ў",
          body: "Літара ў абазначае паўгалосны толькі пасля галосных і ў сярэдзіне слова: раўніна, хвайны. У пачатку слова замест яе пішацца в."
        },
        {
          id: "ph-4",
          title: "Йотацыйныя галосныя",
          body: "Літары я, ю, е, ё абазначаюць спалучэнне й + галосная ў пачатку слова, пасля галоснай або пасьля мяккага знака: яма, мая, салёны."
        },
        {
          id: "ph-5",
          title: "Гук [г] і [х]",
          body: "Беларуская мова адрознівае выбухны [г] і фрыкатыўны [ґ]. У запазычаннях часта выкарыстоўваецца [г], але ў фанетычным пісьме часта пераходзіць у [х]: Германія — [х'ерманія]."
        },
        {
          id: "ph-6",
          title: "Падаўжэнне зычных",
          body: "На мяжы марфем і пры збегу гукаў зычныя могуць падаўжацца: лес сасновы — [л'эсːаˈсновы], жыццё, вадаспад."
        },
        {
          id: "ph-7",
          title: "Спалучэнні дз і дж",
          body: "Спалучэнні дз і дж абазначаюць адзіны афрыкатны гук і пры пераносе не раздзяляюцца: дз-веры — няправільна, трэба: дзе-веры."
        },
        {
          id: "ph-8",
          title: "Асіміляцыя па глухасці",
          body: "Глухія і звонкія зычныя ўплываюць адзін на аднаго: просьба [проз'ба], лісткі [лісткі], дзе глухі гук пераходзіць у звонкі або наадварот."
        },
        {
          id: "ph-9",
          title: "Асіміляцыя па мяккасці",
          body: "Перад мяккімі зычнымі наступныя гукі таксама становяцца мяккімі: пясчаны [п'ашчаны], дзядзька [дз'адзька]."
        },
        {
          id: "ph-10",
          title: "Перанос націску",
          body: "Нагалос у беларускай мове рухомы і можа пераходзіць паміж прыстаўкай і кораням: па́вінен — паві́нны. Варта карыстацца слоўнікам."
        }
      ]
    },
    {
      ...
      rules: [
        {
          ...
          body: "Перад рэ, л, многа скорашчэнняў дадаецца прыстаўная галосная: агляд, узлесак, успамін. Выбар і/а залежыць ад наступнага гука."
        },
        {
          id: "or-2",
          title: "Прыстаўкі з- / с-",
          body: "Перад звонкімі з ідзе, перад глухімі — с: збегчы, зжыць, але спыніць, скінуць."
        },
        {
          id: "or-3",
          title: "Апостраф",
          body: "Апостраф ставіцца пасля прыставак на зычную перад йотацыйнымі галоснымі: аб'ём, без'іменны, д'ябал."
        },
        {
          id: "or-4",
          title: "І і ы пасля ц і ж",
          body: "Пасля ц, ж, ч пад націскам пішацца і, без націску — ы: ціхі, цыбуля; жывапіс, жыцьцё."
        },
        {
          id: "or-5",
          title: "Падвойныя зычныя",
          body: "Падвойныя пазначаюцца двума літарамі, калі сустракаюцца на стыку марфем або ў корані: вясна — вясновы, панна, інавацыя."
        },
        {
          id: "or-6",
          title: "Вялікая літара",
          body: "З вялікай літарай пішуцца ўласныя назвы, гістарычныя падзеі, унікальныя аб'екты: Мінск, Вялікая Айчынная вайна, Нёман."
        },
        {
          id: "or-7",
          title: "Напісанне «не»",
          body: "Часціца не з прыметнікамі пры адсутнасці супрацьпастаўлення пішацца разам: непрыгожы, непатрэбны; пры супрацьпастаўленні — асобна."
        },
        {
          id: "or-8",
          title: "Злучок у складаных словах",
          body: "Складанаскарочаныя словы і геаграфічныя назвы часта пішуцца праз злучок: навукова-тэхнічны, Беразіно-Гродна."
        },
        {
          id: "or-9",
          title: "Іншамоўныя імёны",
          body: "Імёны іншамоўнага паходжання перадаюцца праз і: Інгмар, Міранда, Хірасіма. Літара й ужываецца толькі ў дыпфтонгах."
        },
        {
          id: "or-10",
          title: "Прамая мова",
          body: "Пры прамой мове перад цытатай ставіцца двукроп'е, сама цытата бярэцца ў двукоссі: Яна сказала: «Будзь уважлівы»."
        }
      ]
    },
    {
      ...
      rules: [
        {
          ...
          body: "Жаночы род з асновай на мяккую зычную мае канчатак -я: зямля — зямлі. Пасля шыпячых і гартанных пішацца -а: душа, кніга."
        },
        {
          id: "mo-2",
          title: "Нескланяльныя назоўнікі",
          body: "Запазычаныя словы тыпу метро, табу, фіялета не змяняюцца па склонах, але яны маюць род і кіраванне: сучаснае метро, каля метро."
        },
        {
          id: "mo-3",
          title: "Лічэбнікі з назоўнікамі",
          body: "Пасля лічэбнікаў два, тры, чатыры назоўнік стаіць у назоўным множным, пасля пяці і больш — у родным множным: тры словы, пяць слоў."
        },
        {
          id: "mo-4",
          title: "Кіраванне пасля «трэба»",
          body: "Пасля безасабовых слоў трэба, можна, варта дзеяслоў стаіць у неазначальнай форме: трэба вучыцца, можна пачакаць."
        },
        {
          id: "mo-5",
          title: "Займеннік «сябе»",
          body: "Займеннік сябе не мае назоўнага склону і выкарыстоўваецца ў астатніх: бачыў сябе, ганаруся сабой."
        },
        {
          id: "mo-6",
          title: "Постфікс -ся",
          body: "Постфікс -ся пішацца разам з дзеясловам: смяяцца, мыцца. У формах будучага часу ён ставіцца пасля дапаможнага дзеяслова: буду мыцца."
        },
        {
          id: "mo-7",
          title: "Дзеепрыметнікі",
          body: "Дзеепрыметнікі ўтвараюцца ад асновы дзеяслова: чытаючы, зроблены. Яны ўзгадняюцца з назоўнікам у родзе, ліку і склоне."
        },
        {
          id: "mo-8",
          title: "Парадак слоў",
          body: "Нейтральны парадак — тэма перад рэмай: Мы сёння сустракаемся з сябрам. Змена парадку выкарыстоўваецца для падкрэслівання."
        },
        {
          id: "mo-9",
          title: "Падвоенае адмоўе",
          body: "Адмоўныя займеннікі з часціцай ні патрабуюць адмоўя ў дзеяслове: ніхто нічога не сказаў."
        },
        {
          id: "mo-10",
          title: "Складаназлучаныя сказы",
          body: "Часці складаназлучанага сказа злучаюцца злучнікамі і, але, бо і аддзяляюцца коскамі: Сонца зайшло, і пачаўся дождж."
        }
      ]
    },
    {
      id: "vocabulary",
      title: "Лексіка",
      tagline: "Слоўнікавы склад і словаўтварэнне",
      rules: [
        {
          id: "voc-1",
          title: "Беларускія аналагі",
          body: "Ужывайце беларускія адпаведнікі замежных слоў: камп'ютар — кампутар, прэзідэнт — старшыня, тэлефон — тэлефон."
        },
        {
          id: "voc-2",
          title: "Дыялектызмы",
          body: "Дыялектныя словы ў літаратурнай мове выкарыстоўваюцца для стылістычнага афармлення: бульба (замест бараболь), цыбуля (замест лук)."
        },
        {
          id: "voc-3",
          title: "Неалагізмы",
          body: "Новыя словы ў беларускай мове ўтвараюцца з уласных марфем: інтэрнэт, благаер, сеціва."
        },
        {
          id: "voc-4",
          title: "Сінанімічныя шэрагі",
          body: "Беларуская мова багатая на сінанімы: хуткі — імклівы — паспешны; прыгожы — харошы — цудоўны."
        },
        {
          id: "voc-5",
          title: "Фразеалагізмы",
          body: "Устойлівыя выразы перадаюць нацыянальны каларыт: як сцяць бабамі, вады не замуціць, нажы ў кішэні шукаць."
        }
      ]
    },
    {
      id: "punctuation",
      title: "Пунктуацыя",
      tagline: "Знакі прыпынку і афармленне тэксту",
      rules: [
        {
          id: "punc-1",
          title: "Коска пры аднародных членах",
          body: "Аднародныя члены сказа злучаюцца злучнікамі і, а, але і аддзяляюцца коскамі: Сонца, вецер і дождж стваралі ўражанне."
        },
        {
          id: "punc-2",
          title: "Двукроп'е перад пералічэннем",
          body: "Перад пералічэннем ставіцца двукроп'е: На стале ляжалі: кнігі, сшыткі, ручкі і аловак."
        },
        {
          id: "punc-3",
          title: "Знакі прыпынку пры зваротах",
          body: "Звароты выдзяляюцца коскамі: Дарагія сябры, запрашаем вас на свята."
        },
        {
          id: "punc-4",
          title: "Прамая мова",
          body: "Прамая мова афармляецца двукоссем і аддзяляецца ад слоў аўтара двукроп'ем або коскай: Ён сказаў: «Прыходзь заўтра»."
        },
        {
          id: "punc-5",
          title: "Складаны сказ з падпарадкаваннем",
          body: "Часткі складаназалежнага сказа аддзяляюцца коскамі: Я ведаў, што ён прыйдзе, калі зможа."
        }
      ]
    }
  ];
  ...
  function setupAuthHandlers() {
    ...
    // Добавляем обработчик темы на экране аутентификации
